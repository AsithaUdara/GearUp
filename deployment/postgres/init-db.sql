...
-- Preferred: inject passwords via psql variables at init time (use -v VAR=value or pass through your container orchestration).
-- Example: psql -v AUTONOMOBILE_DB_PASSWORD='...' -f init-db.sql
...
-- Local development fallback (commented): if you prefer to use hardcoded dev passwords, uncomment the ALTER USER lines below.
-- ALTER USER svc_automobile_service WITH PASSWORD 'auto_svc_pass_2024';
-- ALTER USER svc_notification_service WITH PASSWORD 'notif_svc_pass_2024';
-- ALTER USER svc_user_auth_service WITH PASSWORD 'auth_svc_pass_2024';
-- ALTER USER svc_template_service WITH PASSWORD 'template_svc_pass_2024';
