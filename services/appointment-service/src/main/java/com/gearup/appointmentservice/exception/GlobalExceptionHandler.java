...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBookingNotFoundException(
        ...
        error.setErrorCode("BOOKING_NOT_FOUND");
    ...
    public ResponseEntity<ErrorResponse> handleTimeSlotNotAvailableException(
        ...
        error.setMessage(ex.getMessage());
        error.setErrorCode("TIME_SLOT_NOT_AVAILABLE");
        error.setPath(request.getDescription(false).replace("uri=", ""));
    ...
    public ResponseEntity<ErrorResponse> handleServiceNotFoundException(
        ...
        error.setError("Not Found");
        error.setMessage(ex.getMessage());
        error.setErrorCode("SERVICE_NOT_FOUND");
        error.setPath(request.getDescription(false).replace("uri=", ""));
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(
        ...
        log.error("Unexpected error in appointment service: {}", ex.getMessage(), ex);

        ErrorResponse error = new ErrorResponse();
        error.setTimestamp(LocalDateTime.now());
        error.setStatus(HttpStatus.INTERNAL_SERVER_ERROR.value());
        error.setError("Internal Server Error");
        error.setMessage("An unexpected error occurred processing your appointment");
        error.setErrorCode("APPOINTMENT_INTERNAL_ERROR");
        error.setPath(request.getDescription(false).replace("uri=", ""));
