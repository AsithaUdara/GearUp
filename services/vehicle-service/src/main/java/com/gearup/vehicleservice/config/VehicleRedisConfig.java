...
/**
 * Redis caching configuration for Vehicle Service
 */
@Configuration
@EnableCaching
public class VehicleRedisConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory,
        ...
        return RedisCacheManager.builder(connectionFactory)
                ...
                .withCacheConfiguration("vehicles",
                    cacheConfiguration.entryTtl(Duration.ofMinutes(45)))
                .withCacheConfiguration("userVehicles",
