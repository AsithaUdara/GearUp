...
public class DataSeeder {
    ...
    private void seedCustomerAnalytics() {
        ...
        BigDecimal retentionRate = new BigDecimal("82.35");    // ← CHANGE THIS: Retention rate percentage
    ...
    private void seedPopularServices() {
        ...
        services.add(PopularServices.builder()
                ...
                .percentageOfTotal(new BigDecimal("36.8"))          // ← CHANGE THIS
                .rankPosition(1)
                .build());
        ...
        services.add(PopularServices.builder()
                ...
                .percentageOfTotal(new BigDecimal("27.5"))          // ← CHANGE THIS
                .rankPosition(2)
                .build());
        ...
        services.add(PopularServices.builder()
                ...
                .percentageOfTotal(new BigDecimal("24.3"))          // ← CHANGE THIS
                .rankPosition(3)
                .build());
        ...
        services.add(PopularServices.builder()
                ...
                .percentageOfTotal(new BigDecimal("16.7"))          // ← CHANGE THIS
                .rankPosition(4)
                .build());
        ...
        services.add(PopularServices.builder()
                ...
                .percentageOfTotal(new BigDecimal("12.0"))          // ← CHANGE THIS
                .rankPosition(5)
                .build());
